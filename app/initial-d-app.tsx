...
export default function InitialDApp() {
  ...
  return <main>
    ...
    <footer className="footer"><div className="brand"><span className="brand-slash">{"//"}</span><span>INITIAL D <b>START LINE</b></span></div><p>ファンによる非公式コミュニティサイトです。ゲームメーカーおよび権利者各社とは関係ありません。<br/>ゲーム名・車名・商標等は各権利者に帰属します。投稿内容は個人の体験です。</p><div><a href="/guidelines">投稿ガイドライン</a><a href="/privacy">プライバシー</a><a href="#faq">FAQ</a></div></footer>
